...
public:
    ...
    virtual glm::mat4 build(buildSetting _settings, bool _addVerts, bool _extents = false) { return glm::mat4(1.f); }
    ...
    virtual glm::mat4 getRoot(bool _cullDead) { return glm::mat4(1.f); }
    virtual lodBake* getBakeInfo(int i) { return nullptr; }    // so does nothing if not implimented
...
public:
    ...
    computeShader		compute_sortCombine_POST;
