...
// STRIP-REVIEW: file-dialog picker, was only reachable from removed editor GUI - but it is the sole entry point to the Grove OBJ tree-import pipeline (load_obj etc.), so kept.
