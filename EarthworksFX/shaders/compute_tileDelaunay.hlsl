// Emit terrain triangles from the flooded vertex map into the shared vertex
// buffer, accumulating the per-tile triangle count. Ported verbatim from
// docs/source_extract/shaders/compute_tileDelaunay.hlsl.
